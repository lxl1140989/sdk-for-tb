...
define Image/Checksum
	( cd ${BIN_DIR} ; \
		[ -f ${BIN_DIR}/openwrt-xburst-canna-root.jffs2-32k ] && $(STAGING_DIR_HOST)/bin/final_fw ${BIN_DIR}/openwrt-xburst-canna-uImage.bin ${BIN_DIR}/openwrt-xburst-canna-root.jffs2-32k \
